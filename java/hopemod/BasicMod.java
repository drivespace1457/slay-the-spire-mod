...
import hopemod.potions.BasePotion;
import hopemod.relics.BaseRelic;
import hopemod.util.GeneralUtils;
import hopemod.util.KeywordInfo;
import hopemod.util.Sounds;
import hopemod.util.TextureLoader;
...
public class BasicMod implements
    ...
    public void receivePostInitialize() {
        ...
        BaseMod.addEvent(hopemod.events.Get_off_work.ID, hopemod.events.Get_off_work.class);
