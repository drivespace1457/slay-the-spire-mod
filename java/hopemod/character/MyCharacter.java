...
import hopemod.cards.*;
import hopemod.powers.STPower;
import hopemod.relics.MyRelic;
import hopemod.relics.STPDrewRelic;
import hopemod.relics.STPRelic;
import hopemod.relics.STPSubRelic;

import java.util.ArrayList;

import static hopemod.BasicMod.characterPath;
...
public class MyCharacter extends CustomPlayer {
    ...
    //Strings
    private static final String ID = makeID("hope"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass The_Hope;
    ...
    public MyCharacter() {
        super(getNames()[0], Meta.The_Hope,
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(Defend.ID);
        retVal.add(Defend.ID);
        retVal.add(MaxAttack.ID);
        retVal.add(STPEnergy.ID);
        retVal.add(AroundAttackSTP.ID);
    ...
    public void preBattlePrep() {
        super.preBattlePrep();
        STPower.gainedThisTurnOne = 1;
    }
    @Override
    public void onVictory() {
        super.onVictory();
        // 戰鬥勝利，清空數值，確保大地圖、商店看到的都是 0
        STPower.gainedThisTurnOne = 0;
    }
}
