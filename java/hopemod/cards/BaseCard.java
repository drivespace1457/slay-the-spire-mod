...
import hopemod.BasicMod;
import hopemod.util.CardStats;
import hopemod.util.TriFunction;
...
import static hopemod.util.GeneralUtils.removePrefix;
import static hopemod.util.TextureLoader.getCardTextureString;
