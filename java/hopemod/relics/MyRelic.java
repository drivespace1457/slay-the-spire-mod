...
public class MyRelic extends BaseRelic {
    ...
    private static final int Dexterity = 1; //For convenience of changing it later and clearly knowing what the number means instead of just having a 10 sitting around in the code.
    ...
    public void onUseCard(AbstractCard targetCard, UseCardAction useCardAction) {
        addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new DexterityPower(AbstractDungeon.player, Dexterity)));
    }
    ...
    public String getUpdatedDescription() {
        return String.format(DESCRIPTIONS[0], Dexterity);
    }
}